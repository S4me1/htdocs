...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Ehliyet Vesika Sorgu</title>
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Ehliyet Vesika Sorgu</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="anasayfa">Ana Sayfa</a>
                                </li>
                                <li class="breadcrumb-item active"> Ehliyet Vesika Sorgu
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> Ehliyet Vesika Sorgu</h4>
                            </div>
                            <form action="vesika" method="POST">
                                <div class="card-body">
                                    <div class="row">
...
$filename = "https://ajexnetwork.com.tr/api/ehliyet?auth=fonnynewapi@3145@&tc=$tc";
