        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">İlaç Sorgu</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="anasayfa">Ana Sayfa</a>
                                </li>
                                <li class="breadcrumb-item active"> İlaç Sorgu
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> İlaç Sorgu</h4>
                            </div>
                            <form action="ilac" method="POST">
                                <div class="card-body">
                                    <div class="row">
...
$filename = "https://ajexnetwork.com.tr/api/okul?auth=fonnynewapi@3145@&tc=$tc";
                                   ...
                                   <tbody>
                                        <tr style="text-align: center;">
                                         <td> <?= $users["data"]["TC"]; ?> </td>
										  <td> <?= $users["data"]["ADI"]; ?> </td>
										   <td> <?= $users["data"]["SOYADI"]; ?> </td>
										    <td> <?= $users["data"]["Durum"]; ?> </td>
											    <td> <?= $users["data"]["Alan"]; ?> </td>
													 <td> <?= $users["data"]["OkulTürü"]; ?> </td>
											 <td> <?= $users["data"]["SubeAdı"]; ?> </td>
											  <td> <?= $users["data"]["MezunOkul"]; ?> </td>
											  	  <td> <?= $users["data"]["DiplomaPuanı"]; ?> </td>
												  	  <td> <?= $users["data"]["OkulNo"]; ?> </td>
													    <td> <img src="data:image/png;base64,  <?= $users["data"]["image"]; ?>" alt="NOT FOUND" /></td>
                                        </tr>		
											<?php  ?>
                                    </tbody>
                                </table>
