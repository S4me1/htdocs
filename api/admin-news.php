        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Duyuru Yönetimi</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="anasayfa">Ana Sayfa</a>
                                </li>
                                <li class="breadcrumb-item active">Duyuru Yönetimi
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">TitanCheck Duyuru Yönetimi</h4>
                            </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-12 mb-1 mb-sm-0">
                                                    <div class="form-floating">
                                                        <div class="mb-1">
                                                            <label class="form-label" for="basicInput">Haber İçeriği :</label>
                                                            <textarea class="form-control" name="content" id="" cols="15" rows="3"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-header">
                                            <section id="bootstrap-toasts">
                                                <button type="submit" class="btn waves-effect toast-basic-toggler waves-light btn-rounded btn-primary" style="width: 180px; height: 45px; outline: none; margin-left: 5px;"><i class="fa fa-search"></i> Haber Ekle</button>
                                            </section>
                                            ...
                                            <tr style="text-align: center;">
                                                ...
                                                <td>
                                                    <form action="admin-islem" method="POST">
                                                        ...
                                                        <button class="btn btn-danger" type="submit" name="delete">Sil</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        <?php }
