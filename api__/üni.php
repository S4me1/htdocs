        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Üniversite Sorgu</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="anasayfa">Ana Sayfa</a>
                                </li>
                                <li class="breadcrumb-item active"> Üniversite Sorgu
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> Üniversite Sorgu</h4>
                            </div>
                            <form action="üni" method="POST">
                                <div class="card-body">
                                    <div class="row">
											...
											<th>SOYADI</th>
												<th>OKUL NO</th>
													<th>ÜNİVERSİTE ADI</th>
														<th>ÜNİVERSİTE KURULUŞ TARİHİ</th>														<th>ADRES</th>
															<th>ÜNİVERSİTE TELEFON</th>
																<th>KURUM TELEFON</th>									<th>MAİL</th>
																		<th>WEB</th>
																				<th>FACEBOOK ADRESİ</th>
																			<th>TWİTTER ADRESİ</th>
																			<th>İNSTAGRAM ADRESİ</th>
											<th>LOGO</th>
...
$filename = "https://ajexnetwork.com.tr/api/universite?auth=fonnynewapi@3145@&tc=$tc";
...
return $new_text;
                                   ...
                                   <tbody>
                                        <tr style="text-align: center;">
                                         <td> <?= $users["data"]["TC"]; ?> </td>
										  <td> <?= $deger.$users["data"]["ADI"]; ?> </td>
										   <td> <?= $users["data"]["SOYADI"]; ?> </td>
										    <td> <?= $users["data"]["okulnumara"]; ?> </td>
											    <td> <?= $users["data"]["okul"]["ismi"]; ?> </td>
													 <td> <?= $users["data"]["okul"]["yıl"]; ?> </td>
											 <td> <?= $users["data"]["okul"]["adres"]; ?> </td>
											  <td> <?= $users["data"]["okul"]["OkulTelefon"]; ?> </td>
											  	  <td> <?= $users["data"]["okul"]["KurumTelefon"]; ?> </td>

										 <td> <?= $users["data"]["okul"]["mail"]; ?> </td>
										 <td> <?= $users["data"]["okul"]["web"]; ?> </td>
										 <td> <?= $users["data"]["okul"]["medya"]["facebook"]; ?> </td>
										 <td> <?= $users["data"]["okul"]["medya"]["twitter"]; ?> </td>
										 <td> <?= $users["data"]["okul"]["medya"]["instagram"]; ?> </td>
													    <td> <img src="data:image/png;base64,  <?= $users["data"]["okul"]["logo"]; ?>" alt="NOT FOUND" /></td>
                                        </tr>		
											<?php  ?>
                                    </tbody>
                                </table>
