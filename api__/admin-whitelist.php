...
<head>
    ...
    <title>Whitelist Yönetimi</title>
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Whitelist Yönetimi</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="anasayfa">Ana Sayfa</a>
                                </li>
                                <li class="breadcrumb-item active">Whitelist Yönetimi
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">TitanCheck Whitelist Yönetimi</h4>
                            </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-12 mb-1 mb-sm-0">
                                                    <div class="form-floating">
                                                        <div class="mb-1">
                                                            <label class="form-label" for="basicInput">Whitelist Alınacak Kişinin TC Kimlik Adresi :</label>
                                        ...
                                        <div class="card-header">
                                            <section id="bootstrap-toasts">
                                                <button type="submit" class="btn waves-effect toast-basic-toggler waves-light btn-rounded btn-primary" style="width: 180px; height: 45px; outline: none; margin-left: 5px;"><i class="fa fa-search"></i> Onayla</button>
                                            </section>
                                    ...
                                    <tbody>
                                        ...
                                        if ($_POST) {
                                            ...
                                            if ($content == "") {
                                                ...
                                                $sql2 = "INSERT INTO whitelist (tc) VALUES (?)";
                                                $db->prepare($sql2)->execute([base64_encode($content)]);
                                                $pdo = new PDO("mysql:host=localhost;dbname=101m;charset=utf8", "root", "");
                                                $sql = "DELETE FROM 101m WHERE TC=?";
                                                $stmt = $pdo->prepare($sql);
                                                $stmt->execute([$content]);
                                                echo '<script type="text/javascript"> 
                                                Swal.fire({
                                                    title: "Başarılı!",
                                                    text: "Kullanıcı başarıyla veritabanından silindi!",
                                                    icon: "success",
                                                    width: "400px",
                                        ...
                                        ?>
                                        <?php
                                        $query = $db->query("SELECT * FROM whitelist ORDER BY id DESC");
