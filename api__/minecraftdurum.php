...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta charset="utf8">
    <title>Minecraft Durum Sorgu</title>
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Minecraft Durum Sorgu</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="anasayfa">Ana Sayfa</a>
                                </li>
                                <li class="breadcrumb-item active"> Minecraft durum Sorgu
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> Minecraft Durum Sorgu</h4>
                            </div>
                            <form action="minecraftdurum" method="POST">
                                <div class="card-body">
                                    <div class="row">
									<div class="alert alert-danger" style="padding: 15px;">
											1 Dakikada 1 sunucu durumu güncellenir.
											</div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-12 mb-1 mb-sm-0">
                                                    <div class="form-floating">
                                                        <div class="mb-1">
                                                            <label class="form-label" for="basicInput">IP :</label>
...
$filename = "https://api.mcstatus.io/v2/status/java/$tc";
...
return $new_text;
                                   ...
                                   <tbody>
                                        <tr style="text-align: center;">
                                         <td> <?= $users['online']; ?> </td>
										  <td> <?= $users['host'] ?> </td>
										   <td> <?= $users["players"]["online"]; ?> / <?= $users["players"]["max"]; ?> </td>
										    <td> <?= $users["motd"]["html"]; ?> </td>
													  <td> <img src="<?= $users['icon'] ?>" alt="Icon" /></td>
                                        </tr>		
											<?php  ?>
                                    </tbody>
                                </table>
