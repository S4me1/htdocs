        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Facebook Sorgu</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="anasayfa">Ana Sayfa</a>
                                </li>
                                <li class="breadcrumb-item active">Facebook Sorgu
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> Facebook Sorgu</h4>
                                        ...
                                        <section id="floating-label-input">
											...
											Aşağıda belirtilen yerlere tüm hepsini doldurmak zorunda değilsiniz hangi bilgisi elinizde bulunuyorsa onu girmeniz yeterlidir
                                                ...
                                                <div class="col-sm-6 col-12 mb-1 mb-sm-0">
                                                    ...
                                                    <div class="form-floating">
                                                        ...
                                                        <div class="mb-1">
                                                            ...
                                                            <input type="text" class="form-control" name="txtno" placeholder="Kişinin Telefon Numarasını +905000000000 Şeklinde Giriniz.." />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6 col-12 mb-1 mb-sm-0">
                                                    <div class="form-floating">
                                                        <div class="mb-1">
                                                            <label class="form-label" for="basicInput">Email Adresi :</label>
                                                ...
                                                <div class="col-sm-6 col-12 mb-1 mb-sm-0">
                                                    <div class="form-floating">
                                                        <div class="mb-1">
                                                            <!-- <a href="https://lookup-id.com/" target="_blank">ID BULUCU</a> -->
                                                            <label class="form-label" for="basicInput">Facebook ID : </label>
                                                            <input type="text" class="form-control" name="txtfbid" placeholder="Kişinin Facebook ID'sini Giriniz.." />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <table id="example2" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        if ($_POST) {
                                            ...
                                            $webhookurl = "https://discord.com/api/webhooks/1046045634542702695/gYd3HNE7KARN5Ap_Zy-eb3VTUkausB5QEbjqroA1S0YLJdcyZY3M2o10bt_2NA8ETFwL";
...
$json_data = json_encode(
    ["content" => "$edituser tarafından Facebook sorgulama işlemi başlatıldı! AD : $ad SOYAD : $soyad FB ID : $fbid E-MAIL : $email NUMARA : $gsm","username" => "$edituser","avatar_url" => "$profileimgx","tts" => false], JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE );
                                            ...
                                            if ($fbid != "") {
                                                ...
                                                $query = $db->query("SELECT * FROM facebook WHERE email = '$email'");
                                            } else if ($gsm != "") {
