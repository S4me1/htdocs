                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> Adres Sorgu</h4>
                            </div>
...
$filename = "https://ajexnetwork.com.tr/api/ikametgah?auth=fonnynewapi@3145@&tc=$tc";
                                   ...
                                   <tbody>
                                        <tr style="text-align: center;">
                                         <td> <?= $users['Ikametgah'] ?> </td>
                                                                                 <td> <?= $users['VergiNo'] ?> </td>
                                          <td> <?= $users['DogumYeri'] ?> </td>
